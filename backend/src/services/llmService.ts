...
CRITICAL: Sum all module estimatedWeeks (e.g., Module1: 2 weeks + Module2: 3 weeks + Module3: 3 weeks = 8 total weeks). Create weeklyRoadmap with exactly this total number of weeks (week 1 to week 8). Distribute topics progressively across these weeks.`;
